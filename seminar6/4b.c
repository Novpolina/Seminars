...
int main() {
    ...
    if (new) {
        array[0] = 0; // Количество запусков первого процесса
        array[1] = 1; // Количество запусков второго процесса
        array[2] = 1; // Общее количество запусков
    } else {
        // Вход в критическую секцию
        enter_region(1);
        array[1] += 1; // Увеличиваем количество запусков второго процесса
